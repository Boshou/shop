<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:84:"D:\phpstudy_pro\WWW\wps.bobo.com\public/../application/admin\view\category\edit.html";i:1574594306;s:75:"D:\phpstudy_pro\WWW\wps.bobo.com\application\admin\view\layout\default.html";i:1572536367;s:72:"D:\phpstudy_pro\WWW\wps.bobo.com\application\admin\view\common\meta.html";i:1572536366;s:74:"D:\phpstudy_pro\WWW\wps.bobo.com\application\admin\view\common\script.html";i:1572536366;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
	...
	<div class="form-group">
	    <label for="c-banner" class="control-label col-xs-12 col-sm-2"><?php echo __('Banner'); ?>:</label>
	    <div class="col-xs-12 col-sm-8">
	        <div class="input-group">
	            <input id="c-banner" class="form-control" size="35" name="row[banner]" type="text" value="<?php echo $row['banner']; ?>">
	            <div class="input-group-addon no-border no-padding">
